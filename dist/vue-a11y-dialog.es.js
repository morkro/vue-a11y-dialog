        ...
        createElementVNode(
          ...
          [
            createElementVNode(
              "div",
              {
                ...
                onClick:
                  _cache[0] ||
                  (_cache[0] = ($event) =>
                    $props.role === "alertdialog" ? void 0 : $setup.close),
              },
              null,
              2
            ),
            createElementVNode(
              ...
              [
                $props.closeButtonPosition == "first"
                  ? (openBlock(),
                    createElementBlock(
                      "button",
                      {
                ...
                $props.closeButtonPosition == "last"
                  ? (openBlock(),
                    createElementBlock(
                      "button",
                      {
...
var Vue3A11yDialog = /* @__PURE__ */ _export_sfc(_sfc_main, [
  ["render", _sfc_render],
]);
var index = {
  install: (app) => {
